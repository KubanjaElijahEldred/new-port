        ...
        >
                ...
                >
                    ...
                    >
                        ...
                        <div style={styles.headerInfo}>
                            ...
                            <p>KEEBIOS (C)2003 Kubanja Elijah Eldred Inc.,</p>
                        </div>
                    </div>
                        ...
                        {showLoadingResources && doneLoading && (
                            <p>
                                ...
                                <b style={styles.green}>
                                    'Kubanja Elijah Eldred Portfolio Showcase'
                                </b>{' '}
                                V1.0
                            </p>
                        )}
            ...
            >
                <div style={styles.startPopup}>
                    ...
                    <div style={styles.spacer} />
                    <div style={styles.spacer} /> */}
                    <p>Kubanja Elijah Eldred Portfolio Showcase 2022</p>
                    {mobileWarning && (
                        <>
                            <br />
                            <b>
